...
// and Methods 2018-2019 (both exams each) in Sep 2026 while the 2019 worked solutions were being
...
export const audits: SubjectAudit[] = [
  {
    ...
    rows: [
      ...
      { year: 2018, exam: 'Exam 2', question: 'MCQ 20', topic: 'Matrix transformation', note: 'Doable — every option is a diagonal matrix, i.e. a horizontal dilation by P and a vertical one by Q. Gradients get multiplied by Q/P and areas by |P|Q, and those two facts settle it. Watch the second condition: g must still be a probability density function, so the area stays 1 and the curve stays non-negative — that is what rules out option B, which most students chose.' },
  ...
  },
  {
    ...
    rows: [
      ...
      { year: 2018, exam: 'Exam 1', question: 'Entire Q1', topic: 'Dynamics and force analysis', note: 'Connected masses over a pulley with one on an inclined plane: label the forces, then resolve them to find the acceleration. Both parts need force analysis — skip the whole question. Everything else on this paper is current.' },
      { year: 2018, exam: 'Exam 1', question: 'Q6', topic: 'Dynamics and force analysis', note: 'Doable — the only mechanics is the definition momentum = mass x velocity. Differentiate the position vector, multiply by 2, evaluate at the two times and subtract. Everything after that one substitution is ordinary vector calculus, and the answer is a vector.' },
