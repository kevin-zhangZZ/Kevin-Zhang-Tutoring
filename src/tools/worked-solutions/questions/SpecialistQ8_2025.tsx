...
const EXAMINER: MCQExaminerStats = {
  ...
  answer: 'A',
  comment: <>In this direction field, the gradients for positive <Katex tex="x" /> values are the same as those for negative <Katex tex="x" /> values, indicating the <Katex tex="x" /> value is squared. When <Katex tex="x = 0" /> and <Katex tex="y > 0" />, the gradient is negative, indicating <b>A</b> is the best response.</>,
}
...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Option <b>A</b>. The horizontal marks lie along <Katex tex="y = x^2" />, which is the visible parabola of zero slopes.</>,
  },
]
...
export default function SpecialistQ8_2025() {
  return (
    <MCQShell
      question={<p>Consider the direction field below.</p>}
      diagram={DIAGRAM}
      options={[
