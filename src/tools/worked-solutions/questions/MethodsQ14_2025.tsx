...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Option <b>B</b>; about <Katex tex="1.71" />. Rationalising gives the equivalent <Katex tex="\tfrac{2+\sqrt2}{2}" /> — note that option <b>D</b> is the <em>reciprocal</em>, which is what forgetting to invert produces.</>,
  },
]
    ...
    <MCQShell
      question={
        <div className="flex flex-col gap-3">
          ...
          />
          <p>
            and <Katex tex="k" /> is a positive real number. The value of <Katex tex="k" /> is
          </p>
        </div>
      }
      options={[
