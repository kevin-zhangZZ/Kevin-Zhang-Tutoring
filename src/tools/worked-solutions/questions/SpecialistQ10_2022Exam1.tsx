...
const EXAM_B: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      <Katex tex="\sec^2(4x)" />. Students needed to determine{' '}
      <Katex tex="\tan\!\left(\tfrac{\pi}{12}\right)" />; some had difficulty solving the
      quadratic arising from the double angle formula or chose the wrong solution, and
...
const ROWS_A: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: 'A free accuracy check — the report says some sketches failed this.',
  },
]
...
const ROWS_B: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The difference formula, then rationalising with <Katex tex="\sqrt3-1" />. The double angle route <Katex tex="t^2+2\sqrt3\,t-1=0" /> gives <Katex tex="t=-\sqrt3\pm2" />, and only <Katex tex="2-\sqrt3" /> is positive — choosing the other root is the report's named error.</>,
  },
  {
  ...
  },
  {
    ...
    reason: <>Dividing numerator and denominator by 2 puts it in the required form with <Katex tex="a=3" />, <Katex tex="b=3" />, <Katex tex="c=6" />; about <Katex tex="0.664" />. The unsimplified <Katex tex="\tfrac{\left(6-2\sqrt3\right)\pi}{12}" /> was also accepted.</>,
  },
]
    ...
    <div className="flex flex-col gap-8">
      ...
      >
        ...
        <div className="bg-white border border-gray-200 dark:border-gray-800 rounded-xl p-3 w-fit">
          <img
            src={sketchSrc}
            alt="Three branches of y = sec(4x): an upward-opening branch with minimum (0, 1) between the dashed asymptotes x = −π/8 and x = π/8, and two downward branches outside them rising to the endpoints (−π/4, −1) and (π/4, −1)"
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            the <Katex tex="x" />-axis to form a solid of revolution. Find the volume of this
            solid. Give your answer in the form{' '}
            <Katex tex="\dfrac{\left(a-\sqrt b\right)\pi}{c}" />, where{' '}
            <Katex tex="a,b,c\in\mathbb{R}" />.
          </>
        }
