...
const ROWS_C: WorkingRow[] = [
  {
    ...
    reason: <>The two curves swap order at the middle intersection, so the integrand must swap too. The report names having the functions in the incorrect order on both intervals as a common mistake.</>,
  },
  {
...
const ROWS_E: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Only <Katex tex="7\%" /> of students scored both marks. Sensible: the two areas are <Katex tex="1" /> and <Katex tex="1" /> out of a rectangle of <Katex tex="2" />, so <Katex tex="g" /> divides its bounding box exactly in half — which is why the reflection leaves the area unchanged.</>,
  },
]
...
const ROWS_F: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>(<Katex tex="\approx2.12" />.) Then both endpoints sit at <Katex tex="\left(\sqrt2,\sqrt2\right)" /> on the line <Katex tex="y=x" />. Only <Katex tex="8\%" /> of students scored this mark.</>,
  },
]
