...
// image-only, so read from rendered pages); the Argand diagram is our own drawing of the
// answer. Answers checked with sympy and against the VCAA examination report. Solution is
// original.

import Katex from '../../../components/Katex'
import { Background, PartCard, WorkingTable, type WorkingRow, type SAExaminerStats } from '../QuestionParts'
import argandSrc from './spec-2024e2-q2c-argand.png'
...
const EXAM_A: SAExaminerStats = {
  ...
  comment: (
    <>
      This question part was generally answered well. Some students did not provide
      sufficient working to gain both marks. Several students made sign errors when
      substituting into the distance formula. Students who used the perpendicular bisector
      method mostly found the gradient correctly, but some did not use the midpoint
      correctly.
    </>
  ),
}
...
const EXAM_B: SAExaminerStats = {
  ...
  comment: (
    <>
      Students who showed working to find the midpoint and diameter usually answered
      successfully. Some students did not divide the diameter by 2 to find the radius.
      Several did not use the midpoint formula accurately.
    </>
  ),
}
...
const EXAM_C: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      extreme points and should not have a pointed shape. Most students correctly labelled
      the imaginary axis intercepts.
    </>
  ),
}
...
const EXAM_DII: SAExaminerStats = {
  ...
  comment: (
    <>
      Most students who were successful in part d.i. were able to find the correct equation.
      The most common error was to quote the argument as <Katex tex="-\tfrac{\pi}{4}" />.
    </>
  ),
}
...
const ROWS_A: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Squaring both sides with <Katex tex="z=x+iy" />. Sign slips in this line were a listed error.</>,
  },
  {
...
const ROWS_B: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Half the diameter. Forgetting to halve was the error the examiner named.</>,
  },
  {
...
const ROWS_C: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\boxed{\left(2+\sqrt3\right)i \ \text{ and } \ \left(2-\sqrt3\right)i}" />,
    reason: <>About <Katex tex="3.73i" /> and <Katex tex="0.27i" />. Both had to be labelled, and the circle drawn smoothly rather than with a pointed outline.</>,
  },
]
...
const ROWS_DI: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\boxed{\text{see the ray drawn on the diagram below}}" />,
    reason: <>The line has equation <Katex tex="x+y=1" />, which is a useful check: both <Katex tex="(2,-1)" /> and <Katex tex="(-2,3)" /> satisfy it.</>,
  },
]
...
const ROWS_DII: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Not <Katex tex="-\tfrac{\pi}{4}" />, which is what a calculator returns for <Katex tex="\arctan(-1)" /> and which points the opposite way — the error the examiner singled out.</>,
  },
  {
...
const ROWS_E: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The right triangle from the centre to the midpoint of the chord. So the chord subtends <Katex tex="\theta=\tfrac{\pi}{2}" /> at the centre — using the wrong angle here was the listed error.</>,
  },
  {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4">
        ...
        <p>
          Throughout this question <Katex tex="z=x+iy" />, <Katex tex="z_1=1+2i" /> and{' '}
          <Katex tex="z_2=4" />.
        </p>
      </div>
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            <Katex tex="y=mx+c" />, where <Katex tex="x,y,m,c\in\mathbb{R}" />,{' '}
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            diameter of a circle. Find the equation of this circle in the form{' '}
      ...
      <PartCard
        ...
        statement={
          <>
            A second circle is given by <Katex tex="|z-(1+2i)|=2" />. Sketch this circle on an
            Argand diagram, labelling the imaginary axis intercepts with their values.
          </>
        }
      ...
      >
        ...
        <div className="bg-white border border-gray-200 dark:border-gray-800 rounded-xl p-3 w-fit">
          <img
            src={argandSrc}
            alt="An Argand diagram showing a circle of radius 2 centred at 1 + 2i with its two imaginary-axis intercepts labelled, and a ray starting at 2 − i running up and to the left through −2 + 3i and across the circle"
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            <Katex tex="\text{Arg}(z-z_0)=\theta" /> where <Katex tex="z_0\in\mathbb{C}" /> and{' '}
