...
const EXAMINER: MCQExaminerStats = {
  ...
  comment: (
    <>
      ...
      vanillin is often blended with significant amounts of impurities discounts option B as being a
      viable response.
    </>
  ),
}
...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Lower and broader, as expected for a significantly impure sample.</>,
  },
  {
    working: <b>The blend would melt over a range closest to 68–79 °C.</b>,
    reason: <>Matches option <b>A</b>. Option <b>B</b>, chosen by 28%, is ruled out by the &ldquo;significant amounts&rdquo; of other compounds in the stem (the report&rsquo;s point).</>,
  },
]
      ...
      question={
        <>
          <p className="mb-2">
            ...
            <br />
            To reduce costs, it is often blended with significant amounts of cheaper compounds
            that have similar melting points.
          </p>
          <p className="mb-2">A blended sample was tested.</p>
          <p>The melting point range of the blend would be closest to</p>
        </>
      }
      options={[
