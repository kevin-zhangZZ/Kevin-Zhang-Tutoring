...
const EXAM_EII: SAExaminerStats = {
  ...
  comment: (
    <>
      Most students correctly eliminated <Katex tex="Q=0" /> and <Katex tex="Q=1000" /> to
      give the correct answer. Some students gave the maximum rate as their final answer.
    </>
  ),
}
...
const EXAM_F: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      <Katex tex="y=1000" /> and some did not follow the instruction to label the{' '}
...
const ROWS_EI: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The chain rule — <Katex tex="\tfrac{dQ}{dt}" /> is a function of <Katex tex="Q" />, and <Katex tex="Q" /> is a function of <Katex tex="t" />. Differentiating with respect to <Katex tex="Q" /> alone is the report's named error.</>,
  },
  {
...
const ROWS_EII: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: 'Both are equilibria, where the population is not growing at all — minima of the growth rate, not maxima.',
  },
  {
  ...
  },
  {
    ...
    reason: <>To the nearest year. The question asks for both the population and the time, so give both — the maximum <em>rate</em> was not asked for.</>,
  },
]
...
const ROWS_F: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The vertical variable here is <Katex tex="Q" />, not <Katex tex="y" /> — writing <Katex tex="y=1000" /> was the report's most common labelling error.</>,
  },
  {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <PartCard
        ...
        statement={
          <>
            The logistic differential equation can be expressed as{' '}
            <Katex tex="\displaystyle\int\left(\frac AP+\frac{B}{1-\frac{P}{1000}}\right)dP=\int dt" />
            , where <Katex tex="A,B\in\mathbb{R}" />. Find the values of <Katex tex="A" /> and{' '}
            <Katex tex="B" />.
          </>
        }
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            constant. Find the value of <Katex tex="D" />.
          </>
        }
      ...
      <PartCard
        ...
        statement={
          <>
            Find the value of <Katex tex="Q" /> when <Katex tex="t=6" />. Give your answer
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            provided. Label any axis intercepts and any asymptotes with their equations.
          </>
        }
      ...
      >
        ...
        <div className="bg-white border border-gray-200 dark:border-gray-800 rounded-xl p-3 w-fit">
          <img
            src={graphSrc}
            alt="A logistic S-curve rising from (0, 100) through the inflection (2, 500) and flattening towards the dashed asymptote Q = 1000"
      ...
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4">
        <p>
          ...
          <Katex tex="\dfrac{dQ}{dt}=\dfrac{11}{10}Q\left(1-\dfrac{Q}{1000}\right)-0.055Q" />.
        </p>
      </div>
