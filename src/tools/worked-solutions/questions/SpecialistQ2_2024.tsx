...
const EXAMINER: MCQExaminerStats = {
  ...
  comment: (
    <>
      <Katex tex="f(x)=\begin{cases}\dfrac{x^2+3x-10}{x-2}=x+5 & x\in R\setminus\{2\}\\[6pt] 7 & x=2\end{cases}" />
      <br />
      <Katex tex="\therefore \text{ continuous at } x=2" />
    </>
  ),
}
...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Matches option <b>A</b>. Option <b>D</b> (a point of discontinuity), chosen by 37%, would be right if <Katex tex="f(2)" /> were any value other than 7. The graph is a line, so there is no asymptote of either kind — ruling out <b>B</b> and <b>C</b>.</>,
  },
]
    ...
    <MCQShell
      question={
        <div className="flex flex-col gap-3">
          ...
          <Katex
            display
            tex="f(x)=\begin{cases}\dfrac{x^2+3x-10}{x-2} & x\in R\setminus\{2\}\\[8pt] 7 & x=2\end{cases}"
          />
