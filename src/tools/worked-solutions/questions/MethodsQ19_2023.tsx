...
const ROWS: WorkingRow[] = [
  {
    working: <Katex display tex="\Delta = (4k+3)^2-4\left(4k^2-\frac94\right) \ge 0 \ \text{ for two real solutions}" />,
    reason: 'The usual first condition. Strictly, two distinct solutions need Δ > 0.',
  },
  {
  ...
  },
  {
    ...
    reason: <>Option <b>D</b>; this already sits inside <Katex tex="k>-\tfrac34" />, so the discriminant condition adds nothing. Spot-check <Katex tex="k=0" />: <Katex tex="x^2+3x-\tfrac94=0" /> gives <Katex tex="0.68" /> and <Katex tex="-3.68" /> ✓.</>,
  },
]
