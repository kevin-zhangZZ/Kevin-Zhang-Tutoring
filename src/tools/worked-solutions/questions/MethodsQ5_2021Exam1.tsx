...
const EXAM_A: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      the quadratic formula, introducing careless errors and thereby making a simple solution
      process difficult.
    </>
  ),
}
...
const EXAM_B: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      translation, many did not use brackets around the <Katex tex="(x-2)" /> term, leading
      to the incorrect rule <Katex tex="h(x)=(2x-2)^2-4" />. Few students realised that the
      transformation of the <Katex tex="x" />-intercepts could be found independently of the
      rule, by simply transforming points.
    </>
  ),
}
...
const ROWS_B: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: 'Transforming the two points directly is quicker than solving the new rule — and it is the route the report says almost nobody spotted.',
  },
  {
