...
// crops of VCAA's own artwork and the completed curve is our own drawing of the answer.
...
import sketchSrc from './meth-2024e2-q3bi-sketch.png'
...
const EXAM_AI: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      two correct equations; some wrote <Katex tex="p(2)=0" /> and <Katex tex="p(11)=0" />{' '}
      instead of the derivative conditions. Others rounded <Katex tex="101.646\ldots" /> to{' '}
      <Katex tex="101.64" />. The value of <Katex tex="d" /> was sometimes missing.
    </>
  ),
}
...
const EXAM_BI: SAExaminerStats = {
  ...
  comment: (
    <>
      More care needs to be taken when sketching graphs. The turning points and endpoint
      needed to be in the correct positions, and round brackets are required around the
      coordinates. Others made the graph discontinuous at <Katex tex="t=24" />.
    </>
  ),
}
...
const ROWS_AI: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: '… and is stationary there. This second condition is the one most often missed.',
  },
  {
...
const ROWS_BI: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\boxed{\text{see the completed curve below; endpoint } (36,\,5180)}" />,
...
const ROWS_BII: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Only the linear term survives. Dividing by 12 to get 30 — the monthly increase — answers a different question, and was the popular error.</>,
  },
]
...
const ROWS_BIII: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The constant 3000 vanishes and <Katex tex="30t" /> leaves 30. Dropping the <Katex tex="\pi" /> from the coefficients was the common transcription slip.</>,
  },
]
...
const ROWS_BIV: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Both sine terms repeat every 12 months, so whatever happens once happens three times. Giving only one <Katex tex="t" /> value lost a mark.</>,
  },
  {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 flex flex-col gap-3">
        ...
        <p>
          The points shown on the chart below represent monthly online sales in Australia. The
          variable <Katex tex="y" /> represents sales in millions of dollars. The variable{' '}
      ...
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 flex flex-col gap-3">
        ...
        <p>
          A cubic polynomial <Katex tex="p:(0,12]\to\mathbb{R}" />,{' '}
          <Katex tex="p(t)=at^3+bt^2+ct+d" /> can be used to model monthly online sales in
          2021. The graph of <Katex tex="y=p(t)" /> is shown as a dashed curve on the set of
          axes above. It has a local minimum at <Katex tex="(2,2500)" /> and a local maximum
      ...
      <PartCard
        ...
        statement={
          <>
            Let <Katex tex="q:(12,24]\to\mathbb{R}" />, <Katex tex="q(t)=p(t-h)+k" /> be a
            cubic function obtained by translating <Katex tex="p" />, which can be used to
            model monthly online sales in 2022. Find the values of <Katex tex="h" /> and{' '}
      ...
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 flex flex-col gap-3">
        ...
        <div className="py-1">
          <Katex
            display
            tex="f:(0,36]\to\mathbb{R},\ f(t)=3000+30t+700\cos\!\left(\frac{\pi t}{6}\right)+400\cos\!\left(\frac{\pi t}{3}\right)"
          />
        </div>
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            2023, that is, for <Katex tex="t\in(24,36]" />. Label the endpoint at{' '}
      ...
      >
        ...
        <div className="bg-white border border-gray-200 dark:border-gray-800 rounded-xl p-3 w-fit">
          <img
            src={sketchSrc}
            alt="The model curve across the whole domain, with the given portion for t up to 24 in grey and the completed portion for t between 24 and 36 highlighted, ending at the labelled endpoint (36, 5180)"
            className="w-full max-w-[560px]"
          />
        </div>
      </PartCard>
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            increase by <Katex tex="n" /> million dollars. Find the value of <Katex tex="n" />.
          </>
        }
      ...
      <PartCard letter="b.iii" marks={1} statement={<>Find the derivative <Katex tex="f'(t)" />.</>} examinerReport={EXAM_BIII}>
