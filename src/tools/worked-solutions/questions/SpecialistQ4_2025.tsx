...
const EXAMINER: MCQExaminerStats = {
  ...
  comment: (
    <>
      Work through the algorithm methodically as shown below:
      <br />
      <Katex tex="f(x)=\sqrt{x+1}" />
      <table className="mt-1 border-collapse">
        <tbody>
          <tr>
            <td className="px-3 py-1 text-center"><Katex tex="left" /></td>
            <td className="px-3 py-1 text-center"><Katex tex="volume" /></td>
            <td className="px-3 py-1 text-center"><Katex tex="sum" /></td>
          </tr>
          <tr>
            <td className="px-3 py-1 text-center">1</td>
            <td className="px-3 py-1 text-center"><Katex tex="\pi(f(1))^2" /></td>
            <td className="px-3 py-1 text-center"><Katex tex="2\pi" /></td>
          </tr>
          <tr>
            <td className="px-3 py-1 text-center">2</td>
            <td className="px-3 py-1 text-center"><Katex tex="\pi(f(2))^2" /></td>
            <td className="px-3 py-1 text-center"><Katex tex="2\pi+3\pi=5\pi" /></td>
          </tr>
          <tr>
            <td className="px-3 py-1 text-center">3</td>
            <td className="px-3 py-1 text-center"><Katex tex="\pi(f(3))^2" /></td>
            <td className="px-3 py-1 text-center"><Katex tex="5\pi+4\pi=9\pi" /></td>
          </tr>
        </tbody>
      </table>
    </>
...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Matches option <b>B</b>. Stopping at left = 2 gives <Katex tex="5\pi" />; running to left = 4 gives <Katex tex="14\pi" /> — both are offered as distractors.</>,
  },
]
