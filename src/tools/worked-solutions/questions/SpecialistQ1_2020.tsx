...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Matches option <b>D</b>. Check: <Katex tex="a=\tfrac65" /> puts the <Katex tex="y" />-intercept at <Katex tex="\left(0,\tfrac95\right)" />, safely away from the asymptote at <Katex tex="x=2" />.</>,
  },
]
