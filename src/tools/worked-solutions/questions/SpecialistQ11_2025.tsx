...
const EXAMINER: MCQExaminerStats = {
  ...
  answer: 'B',
  comment: <>Use the <Cas fn="solve" /> functionality for differential equations on CAS and then find the domain of the solution. Alternatively, separate the variables and solve by hand.</>,
}
...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Option <b>B</b>. Options A and C allow equality; C and D take the wrong side of the asymptote.</>,
  },
]
