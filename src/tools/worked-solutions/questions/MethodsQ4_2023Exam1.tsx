...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Not <Katex tex="\tfrac32" /> — the report notes <Katex tex="f(2)" /> was commonly given as <Katex tex="\tfrac32" /> instead of <Katex tex="\tfrac52" />.</>,
  },
  {
  ...
  },
  {
    ...
    reason: <>Area of a trapezium <Katex tex="=\tfrac12(a+b)h" />, with the parallel sides vertical here and <Katex tex="h" /> the horizontal width. The formula sheet's trapezium rule, with <Katex tex="\tfrac{x_n-x_0}{2n}=\tfrac{3-1}{2\times2}=\tfrac12" />, gives the same total.</>,
  },
  {
  ...
  },
  {
    ...
    reason: <>About <Katex tex="5.17" /> square units. The exact integral is <Katex tex="4+\log_e(3)\approx5.10" />, so the trapeziums slightly overestimate — as they must, since the curve is concave up here.</>,
  },
]
      ...
      <div className="border border-gray-200 dark:border-gray-800 rounded-2xl p-5 sm:p-6 flex flex-col gap-5">
        <Background>
          <p>
            ...
            answer. Integrating gives <Katex tex="4+\log_e(3)" />, which is a perfectly good
