...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Option <b>A</b>. Sensible: the surface is a cone of slant height <Katex tex="13k" /> and base radius <Katex tex="5k" />, and <Katex tex="\pi r l = \pi(5k)(13k) = 65k^2\pi" /> ✓. Option <b>B</b> is what forgetting to halve gives.</>,
  },
]
    ...
    <MCQShell
      question={
        <div className="flex flex-col gap-1">
          <p>
            The curve defined by the parametric equations <Katex tex="x=5t" />,{' '}
            <Katex tex="y=12t" />, for <Katex tex="0\le t\le k" /> is rotated about the{' '}
            <Katex tex="y" />-axis to form a surface of revolution.
          </p>
