...
const EXAM_AII: SAExaminerStats = {
  marks: [14.17, 85.83],
  average: 0.85,
  comment: <>Found using CAS and the mean and standard deviation found in part a.i.</>,
}
...
const EXAM_D: SAExaminerStats = {
  marks: [46.89, 53.11],
  average: 0.53,
  comment: <>Some responses rounded down to quote 96, but this would have resulted in more than 1 mL.</>,
}
...
const ROWS_AI: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: 'The standard error. Dividing by n instead of √n, or quoting the variance, were the listed slips.',
  },
  {
...
const ROWS_D: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: 'Round up, always. Rounding down to 96 leaves the margin above 1 mL — the error the report singled out.',
  },
]
...
const ROWS_E: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: 'One-tailed, on the lower side — which is what makes the test one-tailed in part f.',
  },
]
...
const ROWS_G: WorkingRow[] = [
  {
    ...
    reason: 'The critical value cuts off 1% in the lower tail — the alternative is μ < 750, so it is the lower tail, not the upper.',
  },
  {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            average volume of water consumed by randomly selected samples of 25 students. Give
            your answers in millilitres.
          </>
        }
      ...
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 flex flex-col gap-3">
        <p className="font-semibold text-gray-900 dark:text-white">b. to d.</p>
        <p>
          The canteen at a particular school stocks two brands of water in bottles, Wasser and
          Apa. The manufacturer of Wasser bottled water knows that the volume of water dispensed
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            Wasser bottle. Give your values in millilitres, correct to one decimal place.
          </>
        }
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            calculate the respective 95% confidence intervals. All samples are independent. In
            how many of these confidence intervals would the engineers expect the value of the
      ...
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 flex flex-col gap-3">
        <p className="font-semibold text-gray-900 dark:text-white">e. to h.</p>
        <p>
          ...
          the mean volume of water dispensed is less than the stated mean of 750 mL. A one-tailed
          statistical test at the 1% level of significance is proposed.
        </p>
      </div>
      ...
      <PartCard
        ...
        statement={
          <>
            Determine the <Katex tex="p" /> value for this test. Give your answer correct to four
            decimal places.
          </>
        }
      ...
      <PartCard
        ...
        statement={
          <>
            Is the company&rsquo;s claim correct? Explain your conclusion in terms of the{' '}
            <Katex tex="p" /> value.
          </>
        }
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            conclusion that the mean volume of water dispensed is now less than 750 mL. Give your
      ...
      <PartCard
        ...
        statement={
          <>
            ...
            <Katex tex="\sigma" />, is 5 mL. At the 1% level of significance, for a sample size
            of 50, find the probability that the company will conclude that the service has not
            reduced the mean volume of water in an Apa bottle. Give your answer correct to three
            decimal places.
          </>
        }
