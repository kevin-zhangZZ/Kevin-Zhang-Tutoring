...
const ROWS: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\boxed{f:\mathbb{R}\to\mathbb{R},\ f(x)=9-3\cos(6x)}" />,
    reason: <>Option <b>C</b>. The minus sign in front of the cosine makes no difference to the range — it only decides whether the curve starts at the bottom or the top.</>,
  },
]
...
export default function MethodsQ1_2025() {
  return (
    <MCQShell
      ...
      options={[
        { letter: 'A', content: <Katex tex="f:\mathbb{R}\to\mathbb{R},\ f(x)=6+3\cos(9x)" /> },
        { letter: 'B', content: <Katex tex="f:\mathbb{R}\to\mathbb{R},\ f(x)=6+6\cos(3x)" /> },
        { letter: 'C', content: <Katex tex="f:\mathbb{R}\to\mathbb{R},\ f(x)=9-3\cos(6x)" />, isAnswer: true },
        { letter: 'D', content: <Katex tex="f:\mathbb{R}\to\mathbb{R},\ f(x)=9-6\cos(3x)" /> },
      ]}
      rows={ROWS}
