...
// original paper; the sketch is our own drawing of the answer. Answers checked with sympy
...
const EXAM_A: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      synthetic division. Some students made algebraic or arithmetic errors.
    </>
  ),
}
...
const EXAM_B: SAExaminerStats = {
  ...
  comment: (
    <>
      The graph needed both asymptotes, <Katex tex="x=1" /> and <Katex tex="y=x+2" />,
      correct and labelled. While the axial intercepts did not need to be labelled, the graph
      line needed to pass through the correct points. Some graphs did not display asymptotic
      behaviour, retreating from the asymptotes, and the oblique asymptote was sometimes
      missing altogether.
    </>
  ),
}
...
const ROWS_A: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\boxed{f(x) = x+2-\frac{4}{x-1}} \ \checkmark" />,
    reason: <>Check by recombining over <Katex tex="x-1" />: <Katex tex="(x+2)(x-1)-4=x^2+x-6" /> ✓. This form is the whole point — the quotient <Katex tex="x+2" /> is the oblique asymptote.</>,
  },
]
...
const ROWS_B: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: 'Straight from part a. Both asymptotes must be drawn and labelled with their equations — this is where most of the marks were lost.',
  },
  {
  ...
  },
  {
    ...
    reason: <>And below it for <Katex tex="x>1" />. Each branch must approach the oblique asymptote from its own side and never cross it — "retreating from the asymptote" was the report's complaint.</>,
  },
]
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <PartCard
        ...
        statement={
          <>
            Sketch the graph of <Katex tex="f" /> on the axes provided, labelling any
      ...
      >
        ...
        <div className="bg-white border border-gray-200 dark:border-gray-800 rounded-xl p-3 w-fit">
          <img
            src={sketchSrc}
            alt="Two increasing branches either side of the dashed vertical asymptote x = 1: the left branch rising from below the dashed line y = x + 2 through (−3, 0) and (0, 6) towards the asymptote, and the right branch climbing from below through (2, 0) and settling under y = x + 2"
