...
const ROWS: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\tan(\pi) = 0 \implies \sin(2\pi a) = 0 \implies 2\pi a = k\pi \implies a = \frac k2, \ k\in\mathbb{Z}" />,
  ...
  },
  {
    ...
    reason: <>Option <b>C</b>. Check: <Katex tex="\sin(-\pi)=0" /> ✓ and <Katex tex="-\tfrac12\cos(-\pi)=\tfrac12" /> ✓. Option <b>D</b>, <Katex tex="+\tfrac12" />, is continuous but has gradient <Katex tex="-\tfrac12" /> — a corner, not a smooth join.</>,
  },
]
