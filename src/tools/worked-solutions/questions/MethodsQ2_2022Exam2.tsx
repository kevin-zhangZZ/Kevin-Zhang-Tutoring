...
const EXAM_AI: SAExaminerStats = { marks: [3, 97], average: 1 }
...
const EXAM_B: SAExaminerStats = {
  ...
  comment: (
    <>
      As this was a "show that" question, appropriate working needed to be shown. Many
      students substituted in points from the graphs and solved simultaneous equations.
    </>
  ),
}
...
const EXAM_C: SAExaminerStats = {
  ...
  comment: (
    <>
      There were rounding errors, with 5340 a common incorrect answer. A common incorrect
      approach was to add the maximum rabbit value to the maximum fox value, without
      recognising that the two maxima occur at different times.
    </>
  ),
}
...
const EXAM_E: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      <Katex tex="r(t)" /> in the integral. 1600 was a common incorrect answer. Some
      students used average rate of change instead of average value.
    </>
  ),
}
...
const EXAM_G: SAExaminerStats = {
  ...
  comment: (
    <>
      ...
      41.8, the value of <Katex tex="s'" /> itself. Another was 76 weeks, which is when the
      rate of change is at its greatest <em>negative</em> value.
    </>
  ),
}
...
const EXAM_H: SAExaminerStats = {
  marks: [44, 56],
  average: 0.6,
  comment: <>A common incorrect answer was 0.</>,
}
...
const ROWS_AII: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Midline minus and plus the amplitude. 700 and 4000 belong to the <em>fox</em> graph and to a misread axis.</>,
  },
  {
...
const ROWS_B: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\text{period} = 160 = \frac{2\pi}{b} \implies \boxed{b = \frac{\pi}{80}} \ \checkmark" />,
    reason: <>Matching the rabbit period, as the stem says it must. A check on the phase: <Katex tex="f(60)=1600" /> and the curve is rising there, consistent with a minimum at 20 and a maximum at 100.</>,
  },
]
...
const ROWS_C: WorkingRow[] = [
  {
    ...
    reason: <>Adding the two models. The two sinusoids are <em>out of phase</em>, so the combined maximum is not <Katex tex="2500+4200" /> — the report's named error.</>,
  },
  {
...
const ROWS_E: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Average <em>value</em> of the <em>combined</em> population — omitting <Katex tex="r(t)" /> gives 1600, the report's named wrong answer.</>,
  },
  {
...
const ROWS_F: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The damping shifts the maxima slightly earlier than the undamped <Katex tex="t=40" /> and <Katex tex="t=200" /> — using those is the report's named shortcut error.</>,
  },
  {
...
const ROWS_G: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The other candidate near <Katex tex="t=76" /> gives the greatest <em>negative</em> rate, which is the report's named wrong answer.</>,
  },
  {
    working: <Katex display tex="\boxed{t = 156 \text{ weeks}}" />,
    reason: <>To the nearest whole number. Note 41.8 is the rate itself, not the time.</>,
  },
]
    ...
    <div className="flex flex-col gap-8">
      <div className="text-[14.5px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 flex flex-col gap-3">
        ...
        <p>
          ...
          foxes are the predators and the rabbits are their prey. The populations of foxes
          and rabbits increase and decrease in a periodic pattern, with the period of both
          populations being the same, as shown in the graph below, for all{' '}
          <Katex tex="t\ge0" />, where time <Katex tex="t" /> is measured in weeks. One point
          of minimum fox population, <Katex tex="(20,700)" />, and one point of maximum fox
          population, <Katex tex="(100,2500)" />, are also shown.
        </p>
        <div className="bg-white border border-gray-200 dark:border-gray-800 rounded-xl p-3 w-fit">
          <img
            src={graphSrc}
            alt="Two out-of-phase sinusoidal population curves against time in weeks: the rabbit curve oscillating about 2500 and the smaller fox curve about 1600 — from the original 2022 VCAA exam paper"
      ...
      <PartCard letter="a.i" marks={1} statement={<>State the initial population of rabbits.</>} examinerReport={EXAM_AI}>
      ...
      <div className="text-[13.5px] leading-relaxed text-gray-600 dark:text-gray-400 px-1">
        <p>
          Over a longer period of time, the increase and decrease in the population of
          rabbits gets smaller and smaller, and can be modelled by{' '}
          <Katex tex="s(t)=1700e^{-0.003t}\sin\!\left(\dfrac{\pi t}{80}\right)+2500" />, for
          all <Katex tex="t\ge0" />.
        </p>
      </div>
      ...
      <PartCard
        ...
        statement={
          <>
            Over time, the rabbit population approaches a particular value. State this value.
          </>
        }
