...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Option <b>A</b>, about <Katex tex="\Pr(Z>2.887)" />. Option D uses a standard deviation of 7 — the result of adding the standard deviations instead of the variances.</>,
  },
]
