...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Matches option <b>D</b>. The phrase "for a non-zero volume of mixture" restricts this to <Katex tex="t<\tfrac{50}{3}" />, when the tank runs dry.</>,
  },
]
    ...
    <MCQShell
      question={
        <p>
          ...
          same time, 5 L of the mixture flows out of the tank per minute. A differential
