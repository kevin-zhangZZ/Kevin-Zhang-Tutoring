...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>The negative root <Katex tex="-3.79" /> is the time the phone would have left the ground had it been thrown; discard it (its size is option <b>C</b>).</>,
  },
  {
    working: <Katex display tex="\boxed{t \approx 4.30 \ \text{seconds}}" />,
    reason: <>Matches option <b>E</b>. Longer than the <Katex tex="4.04" /> s of a straight drop, as it must be — the phone goes up before it comes down.</>,
  },
]
