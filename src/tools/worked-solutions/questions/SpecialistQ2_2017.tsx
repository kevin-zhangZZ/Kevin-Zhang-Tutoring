...
const ROWS: WorkingRow[] = [
  ...
  {
    working: <Katex display tex="\text{Case } \sin(x)>0,\ x\in(0,\pi): \quad \cos(x)\sin(x) > \tfrac14 \iff \sin(2x) > \tfrac12" />,
  ...
  {
    working: <Katex display tex="2x\in(0,2\pi): \ \sin(2x)>\tfrac12 \iff 2x\in\left(\tfrac{\pi}{6},\tfrac{5\pi}{6}\right) \;\implies\; x\in\left(\tfrac{\pi}{12},\tfrac{5\pi}{12}\right)" />,
  },
  {
    working: <Katex display tex="\text{Case } \sin(x)<0,\ x\in(\pi,2\pi): \quad \cos(x)\sin(x) < \tfrac14 \iff \sin(2x) < \tfrac12" />,
