...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Argument of a power again; <Katex tex="\pi" /> is already in the principal range.</>,
  },
  {
  ...
  },
  {
    ...
    reason: <>Already inside <Katex tex="(-\pi,\pi]" />. Matches option <b>A</b>. Option <b>D</b> is <Katex tex="5\,\mathrm{Arg}(z)" /> left unreduced, <b>B</b> is <Katex tex="\mathrm{Arg}(z^5)" /> alone, <b>C</b> is <Katex tex="\mathrm{Arg}(w^4)" /> alone, and <b>E</b> adds the arguments instead of subtracting (<Katex tex="\tfrac{5\pi}{2}+\pi" />).</>,
  },
]
