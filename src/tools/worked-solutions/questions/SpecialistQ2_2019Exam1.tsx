...
// intersection points, since the examination report notes that students could have checked
// their answers and that those who reasoned graphically did better. Cross-checked against the
...
import graphSrc from './spec-2019exam1-q2-abs.png'
...
const EXAMINER: SAExaminerStats = {
  ...
  comment: (
    <>
      Common methods were to solve two linear equations, or to solve a quadratic equation.
      Students who solved linear equations were generally more successful than those who
      solved a quadratic equation; many in the latter group had difficulty solving it. Some
      students drew a graph to support their reasoning. Answers could be verified as correct
      by substitution.
    </>
  ),
}
...
const ROWS: WorkingRow[] = [
  ...
  },
  {
    ...
    reason: <>Always substitute back. An absolute-value equation can throw up solutions that satisfy the rearranged algebra but not the original equation, and this check takes seconds — the report points out it was available to everyone.</>,
  },
  {
    working: (
      <div className="bg-white border border-gray-200 dark:border-gray-800 rounded-xl p-3 w-fit">
        <img src={graphSrc} alt="Graphs of y = |x−4| (a V-shape with vertex at (4,0)) and the line y = x/2 + 7, meeting at (−2, 6) and (22, 18)" className="w-full max-w-[420px]" />
      </div>
    ),
      ...
      <div className="border border-gray-200 dark:border-gray-800 rounded-2xl p-5 sm:p-6 flex flex-col gap-5">
        <Background>
          ...
          <p>
            ...
            students who went that way were markedly less successful.
          </p>
        </Background>
