...
const ROWS: WorkingRow[] = [
  {
    ...
    reason: 'A cumulative condition with the sample size as the unknown.',
  },
  {
  ...
  {
    working: <Katex display tex="n=17: \ 1-0.16677-0.31501 = 0.4818\ldots" />,
    reason: <>Careful — this is <Katex tex="\Pr(X=0)+\Pr(X=1)=0.4818" />, so <Katex tex="\Pr(X\ge2)=0.5182\ge0.5" /> ✓.</>,
  },
  {
    working: <Katex display tex="\boxed{n = 17}" />,
    reason: <>Matches option <b>C</b>. Solving with a CAS gives <Katex tex="n\ge16.6" />, which rounds up to 17.</>,
  },
]
    ...
    <MCQShell
      question={
        <p>
          ...
          <Katex tex="n>2" />. If the probability of obtaining at least two successes after{' '}
          <Katex tex="n" /> trials is at least 0.5, then the smallest possible value of{' '}
          <Katex tex="n" /> is
        </p>
      }
      options={[
